...
class _PengembalianDanaScreenState extends State<PengembalianDanaScreen> {
      ...
      child: Column(
          children: listReimburse!.map((e)  {
            return Padding(
              ...
              child: cardContent(title: "PENGEMBALIAN DANA", status: e.statusReimburse, dateTime: e.tanggalReimburse),
            );
          }).toList(),
        ),
    );
  ...
  Widget cardContent({required String title, required String status, required DateTime dateTime}) {
